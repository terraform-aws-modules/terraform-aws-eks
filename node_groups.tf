...
module "eks_managed_node_group" {
  ...
  tag_specifications                     = try(each.value.tag_specifications, var.eks_managed_node_group_defaults.tag_specifications, ["instance", "volume", "elastic-gpu", "network-interface", "spot-instances-request"])
