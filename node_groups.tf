...
module "eks_managed_node_group" {
  ...
  propagate_labels           = try(each.value.propagate_labels, var.eks_managed_node_group_defaults.propagate_labels, false)
  propagate_label_tag_prefix = try(each.value.propagate_label_tag_prefix, var.eks_managed_node_group_defaults.propagate_label_tag_prefix, "")
  ...
  propagate_taints           = try(each.value.propagate_taints, var.eks_managed_node_group_defaults.propagate_taints, false)
  propagate_taint_tag_prefix = try(each.value.propagate_taint_tag_prefix, var.eks_managed_node_group_defaults.propagate_taint_tag_prefix, "")
