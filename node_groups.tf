...
module "fargate_profile" {
  ...
  selectors         = try(each.value.selectors, null)
  timeouts          = try(each.value.timeouts, null)

  # IAM role
  create_iam_role               = try(each.value.create_iam_role, null)
...
module "eks_managed_node_group" {
  ...
  use_latest_ami_release_version = try(each.value.use_latest_ami_release_version, null)
  ...
  node_repair_config   = try(each.value.node_repair_config, null)
  ...
  enable_bootstrap_user_data = try(each.value.enable_bootstrap_user_data, null)
  ...
  create_placement_group             = try(each.value.create_placement_group, null)
  ...
  iam_role_attach_cni_policy    = try(each.value.iam_role_attach_cni_policy, null)
  iam_role_additional_policies  = lookup(each.value, "iam_role_additional_policies", null)
  create_iam_role_policy        = try(each.value.create_iam_role_policy, true)
  iam_role_policy_statements    = try(each.value.iam_role_policy_statements, null)
...
module "self_managed_node_group" {
  ...
  # Autoscaling Group
  create_autoscaling_group = try(each.value.create_autoscaling_group, null)
  ...
  max_size                = try(each.value.max_size, null)
  desired_size            = try(each.value.desired_size, null)
  desired_size_type       = try(each.value.desired_size_type, null)
  ...
  ignore_failed_scaling_activities = try(each.value.ignore_failed_scaling_activities, null)
  ...
  instance_maintenance_policy = try(each.value.instance_maintenance_policy, null)
  ...
  timeouts               = try(each.value.timeouts, null)
  autoscaling_group_tags = try(each.value.autoscaling_group_tags, null)
