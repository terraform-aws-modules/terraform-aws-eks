...
| security\_group\_rule\_https\_worker\_ingress | Security group rule responsible for allowing pods to communicate with the EKS cluster API. |
| security\_group\_rule\_cluster\_workers\_egress\_internet | Security group rule responsible for allowing pods to communicate with the Internet. |
