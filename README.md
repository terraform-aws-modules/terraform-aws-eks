...
| <a name="input_wait_for_cluster_create_timeout"></a> [wait\_for\_cluster\_create\_timeout](#wait\_for\_cluster\_create\_timeout) | Allows for a configurable timeout when waiting for a cluster to come up | `string` | `300` | no |
