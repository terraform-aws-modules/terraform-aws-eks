...
| <a name="input_create_node_groups"></a> [create\_node\_groups](#input\_create\_node\_groups) | Whether to create node groups (managed EKS node groups) at all. | `bool` | `true` | no |
