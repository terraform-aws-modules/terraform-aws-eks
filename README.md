...
| <a name="input_cluster_prevent_destroy"></a> [cluster\_prevent\_destroy](#input\_cluster\_prevent\_destroy) | Sets value for terraform prevent destroy metaargument | `bool` | `false` | no |
