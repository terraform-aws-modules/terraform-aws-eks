...
| enabled | Destroy-time flag. If set to "false", the count will be set to "0" on all resources. This allows destroy-time provisioners to run successfully. | bool | `"true"` | no |
