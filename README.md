...
| <a name="input_cluster_primary_security_group_custom_tags"></a> [cluster\_primary\_security\_group\_custom\_tags](#input\_cluster\_primary\_security\_group\_custom\_tags) | A map of additional tags to add to the cluster primary security group | `map(string)` | `{}` | no |
