...
| <a name="input_fargate_subnets"></a> [fargate\_subnets](#input\_fargate\_subnets) | Subnets to use when creating fargate profiles. If not set then the all subnets in the cluster will be used. | `list(string)` | `[]` | no |
