...
| local\_exec\_interpreter | Command to run for local-exec resources. Must be a shell-style interpreter. If you are on Windows Git Bash is a good choice. | `list(string)` | <pre>[<br>  "/bin/sh",<br>  "-c"<br>]<br></pre> | no |
