...
| <a name="output_workers_group_defaults"></a> [workers\_group\_defaults](#output\_workers\_group\_defaults) | Merged defaults to use as input to node\_group submodule |
