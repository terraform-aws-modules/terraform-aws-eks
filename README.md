...
| <a name="input_cluster_auth_base64"></a> [cluster\_auth\_base64](#input\_cluster\_auth\_base64) | The base64 encoded certificate data required to communicate with your cluster. | `string` | `""` | no |
...
| <a name="input_cluster_endpoint"></a> [cluster\_endpoint](#input\_cluster\_endpoint) | The endpoint for your EKS Kubernetes API. | `string` | `""` | no |
...
| <a name="input_create_nodegroups"></a> [create\_nodegroups](#input\_create\_nodegroups) | Controls if EKS NodeGroups should be created | `bool` | `true` | no |
