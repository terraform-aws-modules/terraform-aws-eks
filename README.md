...
| <a name="input_cluster_primary_security_group_tags"></a> [cluster\_primary\_security\_group\_tags](#input\_cluster\_primary\_security\_group\_tags) | A map of additional tags to add to the cluster primary security group. This security group is created by the EKS service, not the module, and therefore tagging is handled after cluster creation | `map(string)` | `{}` | no |
