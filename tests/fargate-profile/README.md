...
| <a name="output_dualstack_oidc_provider"></a> [dualstack\_oidc\_provider](#output\_dualstack\_oidc\_provider) | Dual-stack compatible OpenID Connect identity provider (issuer URL without leading `https://`) |
