# AWS EKS Cluster with API Access Configuration

Configuration in this directory creates an AWS EKS cluster with a broad mix of various features and settings provided by this module including API `access_config`:
...
- API Access Config customizations
