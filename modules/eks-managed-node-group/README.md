...
| <a name="input_tag_specifications"></a> [tag\_specifications](#input\_tag\_specifications) | The tags to apply to the resources during launch | `list(string)` | <pre>[<br>  "instance",<br>  "volume",<br>  "elastic-gpu",<br>  "network-interface",<br>  "spot-instances-request"<br>]</pre> | no |
