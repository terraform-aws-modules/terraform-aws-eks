...
| <a name="input_is_custom_ami"></a> [is\_custom\_ami](#input\_is\_custom\_ami) | Determines whether a custom AMI is used or the default AMI in the case of EKS managed node groups | `bool` | `false` | no |
