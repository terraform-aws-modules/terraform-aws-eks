...
| <a name="input_user_data_env"></a> [user\_data\_env](#input\_user\_data\_env) | Map of environment variables to export as part of the user data. Not used when `platform` == `bottlerocket` | `map(string)` | `{}` | no |
