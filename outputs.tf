...
output "workers_asg_arns" {
  ...
  value = concat(
    values(aws_autoscaling_group.workers)[*].arn,
    values(aws_autoscaling_group.workers_launch_template)[*].arn,
  )
}
...
output "workers_asg_names" {
  ...
  value = concat(
    values(aws_autoscaling_group.workers)[*].id,
    values(aws_autoscaling_group.workers_launch_template)[*].id,
  )
}
...
output "workers_user_data" {
  ...
  value = concat(
    values(data.template_file.userdata)[*].rendered,
...
output "workers_launch_template_ids" {
  ...
  value       = values(aws_launch_template.workers_launch_template)[*].id
}

output "workers_launch_template_arns" {
  description = "ARNs of the worker launch templates."
  value       = values(aws_launch_template.workers_launch_template)[*].arn
}

output "workers_launch_template_latest_versions" {
  description = "Latest versions of the worker launch templates."
  value       = values(aws_launch_template.workers_launch_template)[*].latest_version
}
...
output "worker_iam_instance_profile_arns" {
  ...
  value = concat(
    values(aws_iam_instance_profile.workers)[*].arn,
    values(aws_iam_instance_profile.workers_launch_template)[*].arn
  )
}
...
output "worker_iam_instance_profile_names" {
  ...
  value = concat(
    values(aws_iam_instance_profile.workers)[*].name,
    values(aws_iam_instance_profile.workers_launch_template)[*].name
  )
}
...
output "worker_iam_role_name" {
  ...
  value = coalescelist(
    ...
    values(data.aws_iam_instance_profile.custom_worker_group_iam_instance_profile)[*].role_name,
...
output "worker_iam_role_arn" {
  ...
  value = coalescelist(
    ...
    values(data.aws_iam_instance_profile.custom_worker_group_iam_instance_profile)[*].role_arn,
